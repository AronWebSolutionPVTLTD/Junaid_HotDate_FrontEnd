            ...
            <div className="xl:w-4/5">
              ...
              <div className="db_header_nav w-full">
                <ul className="xl:flex items-center justify-between mt-10 grid gap-y-2">
                  <li
                    className={`${
                      pathname === "/home" ? "text-orange" : "text-white hover:text-orange"
                    }`}
                  >
                  ...
                  <li
                    className={`${
                      pathname === "/live-chat" ? "text-orange" : "text-white hover:text-orange"
                    }`}
                  >
                  ...
                  <li
                    className={`${
                      pathname === "/about" ? "text-orange" : "text-white hover:text-orange"
                    }`}
                  >
                  ...
                  <li
                    className={`${
                      pathname === "/contact" ? "text-orange" : "text-white hover:text-orange"
                    }`}
                  >
                  ...
                  <li
                    className={`${
                      pathname === "/travel-page" ? "text-orange" : "text-white hover:text-orange"
                    }`}
                  >
