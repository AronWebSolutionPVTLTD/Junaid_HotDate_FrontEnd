        ...
        <div className="w-full md:w-3/5 xl:w-full 2xl:w-3/5 ">
          <div className="sign-up__form flex flex-col justify-center gap-30 py-6 px-6 lg:py-11 lg:px-14">
            ...
            >
             ...
             { !image ? <label className="flex w-full bg-gray-900 py-[10px] px-4 text-lg items-center cursor-pointer rounded-md">
                  ...
                  />
                </label> :<><label htmlFor={"single_image"} className="flex w-full bg-gray-900 py-[10px] px-4 text-lg items-center cursor-pointer rounded-md"> <input
                  id="single_image"
                    type="file"
                    className="hidden"
                    onChange={(e) => handleCoverImage(e)}
                  /><img  src={image} width={"100%"} style={{maxHeight:"100px"}} height={"10px"}  /></label><span onClick={(e)=>setImage('')} color="white" style={{position:"absolute",cursor:"pointer"}}>❌</span>  </>}
