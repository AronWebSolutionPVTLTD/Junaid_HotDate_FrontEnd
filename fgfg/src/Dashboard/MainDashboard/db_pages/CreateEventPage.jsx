        ...
        <div className="w-full md:w-3/5 xl:w-full 2xl:w-3/5 ">
          <div className="sign-up__form flex flex-col justify-center gap-30 py-6 px-6 lg:py-11 lg:px-14">
            ...
            >
              ...
              <p className="text-lg">Open For *</p>
              <div className="radio_btn_wrapper">
                <div className="radio_field">
                  <input
                    type="radio"
                  ...
                  <label htmlFor="male">
                    <span className="radio_circle"></span>
                    <span className="radio_text">M</span>
                  </label>
                </div>
                <div className="radio_field">
                  <input
                  ...
                  <label htmlFor="female">
                    <span className="radio_circle"></span>
                    <span className="radio_text">F</span>
                  </label>
                </div>
                <div className="radio_field">
                  <input
                  ...
                  <label htmlFor="public_place">
                    <span className="radio_circle"></span>
                    <span className="radio_text">MM</span>
                  </label>
                </div>
                <div className="radio_field">
                  <input
                  ...
                  <label htmlFor="public_place">
                    <span className="radio_circle"></span>
                    <span className="radio_text">FF</span>
                  </label>
                </div>
                <div className="radio_field">
                  <input
                  ...
                  <label htmlFor="public_place">
                    <span className="radio_circle"></span>
                    <span className="radio_text">MF</span>
                  </label>
                </div>
                <div className="radio_field">
                  <input
