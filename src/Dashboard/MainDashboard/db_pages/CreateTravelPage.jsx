...
const [age2,setage2]=useState("")
  ...
  useEffect(()=>{
    ...
    calculateAge() }
    if(userInfo?.profile_type==="couple"){
calculateAge2()
calculateAge()
    }
  },[])

console.log(userInfo.couple.person1.DOB,"info")
  ...
  // _________________AGE CALCULATION_________________
  const calculateAge = () => {
    ...
    alert("2nd")
    let birthDate=new Date(userInfo?.couple?.person1?.DOB)
    const timeDifference = currentDate - birthDate;
    console.log(timeDifference)
    // Calculate age based on milliseconds
    const ageInMilliseconds = new Date(timeDifference);
...
const calculateAge2 = () => {
  const currentDate = new Date();
  const birthDate = new Date(userInfo?.couple?.person2?.DOB)
  const timeDifference = currentDate - birthDate;
  console.log(timeDifference)
  // Calculate age based on milliseconds
  const ageInMilliseconds = new Date(timeDifference);
  ...
  console.log(userInfo,"hdkashkhdakshkdljl")
