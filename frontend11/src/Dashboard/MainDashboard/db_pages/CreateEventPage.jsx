...
const CreateEventPage = () => {
  ...
  const [selectedOpenFor] = useState([
     "M" ,
    "F" ,
    "MF" ,
     "FF" ,
  ...
  const handleCreateEvent = async (e) => {
    ...
    formData.append("accepted_type", selectedOption);
        ...
        <div className="w-full md:w-3/5 xl:w-full 2xl:w-3/5 ">
          <div className="sign-up__form flex flex-col justify-center gap-30 py-6 px-6 lg:py-11 lg:px-14">
            ...
            >
              ...
              <Multiselect
                options={selectedOpenFor} // Options to display in the dropdown
                // selectedValues={this.state.selectedValue} // Preselected value to persist in dropdown
                onSelect={handleSelect} // Function will trigger on select event
                onRemove={handleRemove} // Function will trigger on remove event
                displayValue="selectedOpenFor" // Property name to display in the dropdown options
                isObject={false}
              />
              <button
