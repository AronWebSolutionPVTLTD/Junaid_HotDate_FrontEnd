  ...
  return (
    <li className="menu-item">
      <span className="title_submenu" onClick={toggleSubmenu}>
        ...
        {submenus.length > 0 && (
          <i
            className={`fas fa-chevron-down ${showSubmenu ? 'open' : ''}`}
          ></i>
        )}
      </span>
...
const Sidebar = () => {
  const menuItems = [
    ...
    },
    {
      ...
      submenus: [
        {
          title: 'Speed date ',submenus: []},
        { title: 'Events', submenus: [] },
        { title: 'Clubs', submenus: [] },
        { title: 'Hot or Not (tinder)', submenus: [] },
        { title: 'Travel calendar', submenus: [] },
        { title: 'Live action', submenus: [{ title: 'Member webcam', submenus: [] },{ title: 'Model webcam', submenus: [] },] },
      ],
    },
    {
      title: 'FAQ',
    ...
    {
      title: 'Setting',
      submenus: [{ title: 'My profile', submenus: [] },
      ...
      { title: 'My Points', submenus: [{ title: 'Top up points', submenus: [] }]},
      { title: 'Billing', submenus: [] },
      { title: 'Support', submenus: [] },
      { title: 'About', submenus: [] },
  ...
  const userDetails = async (token) => {
    console.log(token, "KNFKAHDFKLHDFLKHDSKJFDSJKFDSJKFJKDD");
    const id = token._id;
    console.log(id);
    try {
    ...
    <div className="sidebar xl:w-60">
      <div>
        ...
        <div className="pt-0 pb-8 xl:py-4">
          ...
          <p className="flex items-center justify-between gap-4 mb-3 hover:text-orange">
            {userInfo.country}
          ...
          <p
            className="flex items-center justify-between gap-4 hover:text-orange"
