  ...
  return (
    ...
    >
      ...
      <div className="w-3/5 sm:w-full px-4 pr-6 grid content-between relative">
        <div className="">
          <h3 className="text-base sm:text-xl sm:leading-5 break-all max-w-[100px] font-bold">
            {clubs.clubname}
          </h3>
          <span className="text-[12px]">by {clubs.owner_name}</span>
        </div>
        <div className="grid text-[10px] gap-y-1">
          <p className="flex items-center gap-1 font-semi-bold text-[12px]">
