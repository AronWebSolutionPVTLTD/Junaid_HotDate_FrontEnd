    ...
    <div className="w-full cursor-pointer p-3 bg-light-grey rounded-2xl flex flex-wrap sm:grid grid-cols-2 relative">
      ...
      <div className="w-3/5 sm:w-full px-4 grid content-between relative gap-2">
        <div className="flex items-center gap-1 text-xs">
          ...
          <p className="text-[18px] font-medium text-bright-orange">
            {props.username}
          </p>
        </div>
        <div className="flex justify-between items-center">
          <div className="text-s gap-1 flex items-center">
            <span className="text-bright-orange">{props.age}</span>
        ...
        <p className="text-[14px] font-light">{props.introduction}</p>
      </div>
    </div>
  );
};
