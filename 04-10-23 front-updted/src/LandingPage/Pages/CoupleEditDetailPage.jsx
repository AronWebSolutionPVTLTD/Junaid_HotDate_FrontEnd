...
const [person2,setPerson2]=useState({
  ...
  console.log(userInfo.couple.person1.person1_Name,"user")
...
console.log(userInfo)
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `${BASE_URL}/api/update`,
        {couple:JSON.stringify(couple),userId:userInfo._id,introduction:userDetails?.introduction},
        config
      );
  ...
  const handleBodyhair2 = (e) => {
    ...
    setPerson2({...person2,['body_hair']:filter_data})
    } else {
      data.push(e.target.value);
   
     setPerson2({...person2,['body_hair']:data})
    }
  };
