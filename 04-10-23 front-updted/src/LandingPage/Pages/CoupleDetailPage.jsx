...
const CoupleDetailPage = () => {
  ...
  // };
  const RenderedStyle={
    "color":`${userInfo.couple?.person1?.gender=== 'male'?'#3A97FE':userInfo.couple?.person1?.gender=== 'female' ?'#FF2A90':'purple'}`
    }

  const RenderStyle2={
    "color":`${userInfo.couple?.person2?.gender === 'male'?'#3A97FE': userInfo.couple?.person2?.gender=== 'female'?'#FF2A90':'purple'}`
    }
 ...
 :userInfo.couple?.person1?.gender==="male"?
                  <img src="images/Male.png" alt="male" className="h-[26px] mr-1" />: 
                   <img src="images/Trans.png" alt="trans" className="h-[26px] mr-1" />}
                    ...
                    <p className={`text-center flex items-center justify-center text-xl`} style={RenderStyle2}>
