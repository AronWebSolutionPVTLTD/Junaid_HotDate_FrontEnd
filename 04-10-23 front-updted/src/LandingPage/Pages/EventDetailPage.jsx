          ...
          <div className="text-white">
            <div className="flex items-center justify-between gap-5 mb-4">
              ...
              {eventInfo.userId?._id === userInfo._id ? (
                ...
                <div className="inline-flex items-center text-2xl" onClick={()=>deleteEvent(eventInfo._id)}><RiDeleteBin6Line/></div>
                </div>
              ) : eventInfo.type === "Private Event" ? (
                hasUserPending || isJoined ? (
                  <div>
                  <button
                    className="primary_btn !py-1 !text-sm !leading-[28px] mr-2" disabled
                  >
                    Request Sent
                  </button>
                  <button
...
<div>
<p className="text-lg text-orange font-semibold">DISTANCE: <span className="text-white">{ calculatePreciseDistance(eventInfo?.location?.lon,savedCred.long,eventInfo?.location?.lat,savedCred.lat)}miles </span></p>
</div>
                  ...
                  {eventInfo?.accepted_type?.map((el, i) => (
                   ...
                   <img src="images/malemale.png" alt="couple"  className="h-[22px]"/>
                    ...
                    {el === "MF" && (
                     ...
                     {el === "T" && (
                     <img src="images/Trans.png" alt="trans" className="h-[22px]" />
                    )}
                  </>
                  ))}
